...
from core.ui import ASSETS_DIR, AUTHOR_NAME, LINKEDIN_URL
...
with bio_col:
    ...
    st.markdown(
        "Lead data scientist with 10 years of experience delivering "
        "high-impact optimization solutions across the sports, retail, "
        "pharmaceutical, and automotive industries. Expertise in "
        "mathematical optimization and simulation modeling allows him to "
        "drive strategic business decision-making. Recognized for passion "
        "to bridge operations research with corporate objectives.\n\n"
        "**Areas of Expertise:**  \n"
        "Mixed Integer Programming (MIP) | Linear Programming (LP) | "
        "Heuristics | Python | SQL | Simulation Modeling | "
        "Operations Research | Data Science | Data Analytics | "
        "Machine Learning | Mentorship\n\n"
        "**Technical Skills:**  \n"
        "Languages: Python | SQL | R | VBA | MATLAB  \n"
        "Tools: Gurobi | CPLEX | Google Cloud Platform (GCP) | BigQuery | "
        "Claude | ChatGPT | Jupyter Notebook | Tableau | "
        "Visual Studio Code | Alteryx | Snowflake | GitHub | Jira | Hexaly"
    )
    ...
    icon_entry(
        ...
        "*(2026–present)*",
        "Developing data science solutions for pricing optimization.",
    )
    icon_entry(
        "cvs",
        "**Senior Data Scientist — CVS Health** *(2025–2026)*",
        "Led the development and implementation of an advanced optimization "
        "system for Specialty Pharmacy Operations.",
    )
    icon_entry(
        "atd",
        "**Senior Data Scientist — American Tire Distributors (via "
        "Torqata)** *(2023–2025)*",
        "Responsible for large-scale modeling and big data analysis to "
    ...
    icon_entry(
        ...
        "*(2022–2023)*",
        "Designed and deployed pricing optimization solutions supporting "
        "hundreds of golf courses throughout the US.",
    )
    icon_entry(
        "ford",
        "**Operations Research Scientist / Data Scientist — Ford Motor "
        "Company** *(2018–2022)*",
        "Provided algorithm and operations research support for mobility, "
        "autonomous vehicles, and robotics divisions.",
    )
    icon_entry(
        "walmart",
        "**Statistical Analyst — Walmart** *(2016–2018)*",
        "Focused on providing operations research support for supply chain "
        "initiatives.",
    )
