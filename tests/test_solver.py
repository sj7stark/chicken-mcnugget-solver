...
The residue-class (Apéry set) solver is verified against an independent
dynamic-programming oracle (`dp_frobenius`) plus a table of known answers,
so the solver logic is fully tested with no external dependencies.
"""
